...
.DESCRIPTION
  ...
  done using group-object cmdlet. This is significantly faster then using if statements. This example puts the results in an hashtable.
...
$groupedvmsview = $vmsview | Group-Object -Property {$_.Runtime.PowerState} -AsHashTable -AsString
