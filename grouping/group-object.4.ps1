...
.DESCRIPTION
  ...
  done using group-object cmdlet. This is significantly faster then using if statements. This example only takes the element counts,
  ideal for fast bitbucket grouping.
...
$groupedvmsview = $vmsview | Group-Object -Property {$_.Runtime.PowerState} -NoElement
